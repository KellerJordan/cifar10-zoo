...
| `main6_tta.py` | Evalutes with extra multi-crop TTA. | 10.8 | 4.3 | 94.02 in n=200 |
| `main7_mirror.py` | Adds alternating strategy for left-right flip augmentation. | 9.9 | 3.95 | 94.02 in n=700 |
