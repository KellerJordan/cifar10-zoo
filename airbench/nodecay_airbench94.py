...
def main(run):
    ...
    param_configs = [dict(params=norm_biases, lr=lr_biases, weight_decay=0.025),
                     dict(params=conv_weights, lr=0.03175, weight_decay=0),
                     dict(params=[model[0].bias], lr=lr, weight_decay=wd/lr),
                     dict(params=[model[-2].weight], lr=lr, weight_decay=0.75)]
