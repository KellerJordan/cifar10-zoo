"""
## Adversarial split experiment
Constructs balanced halves A and B such that A yields 68.4% and B yields 74.2%.
"""
...
model, log = train(loader, test_loader, epochs=0.5)
