...
def main(run):
    ...
    param_configs = [dict(params=norm_biases, lr=64*lr, weight_decay=wd/64),
                     dict(params=other_params, lr=lr, weight_decay=wd)]
    optimizer = schedulefree.SGDScheduleFree(param_configs, momentum=momentum, warmup_steps=200)
